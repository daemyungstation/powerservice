...
<%@ page import="java.io.IOException" %>         
 <% 
	...
	try{
	    ...
	    //String fileName = "c:\\app\\pdf\\123456.pdf";
	    String sfilePath = "/media/dmrecord1/digitalsign/sForm/dm_sign/";
        request.setCharacterEncoding("EUC-KR");	    
	    String sFileNm = request.getParameter("pfileNm");
	    
	    out.println(">>>>>>>>filename : " + sfilePath + sFileNm);
