 ...
 */
@Controller
@RequestMapping(value = "/dlw/vrtl-acnt/test")
public class DlwVrtlAcntTestController {

    @Resource
    private DlwVrtlAcntTestService DlwVrtlAcntTestService;
    ...
    public ModelAndView getDlwCardCsmmList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            int nTotal = DlwVrtlAcntTestService.getDlwVrtlAcntClctCount(hmParam);

            mapOutVar.put("tc_log", nTotal);

            List<Map<String, Object>> mList = DlwVrtlAcntTestService.getDlwVrtlAcntCsmm(hmParam);
    ...
    public ModelAndView updateDlwPymnCancNicepay(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
         ...
         //       if (rowType == DataSet.ROW_TYPE_UPDATED){
                    DlwVrtlAcntTestService.deleteDlwVrtlAcntClct(hmParam);
           //     }
            }
    ...
    public ModelAndView getDlwVrtlAcntWdrwList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            List<Map<String, Object>> mList = DlwVrtlAcntTestService.getVrtlAccntWdrwReqList(hmParam);
            listMap.setRowMaps(mList);
            mapOutDs.put("ds_output", listMap);
    ...
    public ModelAndView getDlwVrtlAcntWdrwTargetList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            if (listInDs != null && listInDs.size() > 0) {
                ...
                System.out.println("인풋 데이터 컨트롤러 ::: " + hmParam.toString());

                List<Map<String, Object>> mList = DlwVrtlAcntTestService.getVrtlAccntTargetList(hmParam);
                listMap.setRowMaps(mList);
            }
    ...
    public ModelAndView updateDlwVrtlAcntInvGunsu(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            int totalAmt = 0;
            totalAmt = DlwVrtlAcntTestService.getInvAmt(hmParam);
            if (totalAmt <= 0) {
                totalAmt = 0;
            }
    ...
    public ModelAndView deleteNiceVrtlAccntWdrwList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < listInDs.size(); i++) {
                ...
                int rowType = ((Integer) hmParam.get(XPlatformConstant.DATASET_ROW_TYPE)).intValue();
                if (rowType == DataSet.ROW_TYPE_UPDATED){
                    DlwVrtlAcntTestService.deleteNiceVrtlAccntWdrwList(hmParam);
                }
            }
            ...
            for (int i = 0; i < listInDs.size(); i++) {
                ...
                try {
                    ...
                    */
                    ...
                    DlwVrtlAcntTestService.updateNiceVrtlAccntWdrwReq(hmParam);
                } catch(Exception e) {
                    e.printStackTrace();
    ...
    public ModelAndView getDlwVrtlAcntInfo(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            int nTotal = DlwVrtlAcntTestService.getVrtlAccntInfoCount(hmParam);

            mapOutVar.put("tc_info", nTotal);

            List<Map<String, Object>> mList = DlwVrtlAcntTestService.getVrtlAccntInfo(hmParam);
            listMap.setRowMaps(mList);
            mapOutDs.put("ds_output", listMap);
    ...
    public ModelAndView updateVrtlAccntRecoverProc(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < listInDs.size(); i++) {
                ...
                if (rowType == DataSet.ROW_TYPE_UPDATED){
                    DlwVrtlAcntTestService.updateVrtlAccntRecoverProc(hmParam);
                }
            }
    ...
    public ModelAndView vrtlAcntPayByAdmin(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            if (listInDs != null && listInDs.size() > 0) {
                ...
                result = DlwVrtlAcntTestService.vrtlAcntPayByAdmin(hmParam);

            }
            mapOutVar.put("result_msg", result);
...
/*
    ...
    public void niceVacctNoti(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String sResult = "";
        try {
            int cudCnt = DlwVrtlAcntTestService.insertNiceVacctNoti(hm);
            sResult = "OK";
        } catch (Exception ex) {
            sResult = "FAIL";
        }
