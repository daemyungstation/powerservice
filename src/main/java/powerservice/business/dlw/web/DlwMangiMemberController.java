...
public class DlwMangiMemberController {
     ...
     * ================================================================
     * */
    @RequestMapping(value = "/dlw/mangi/ext/getMangiResnLIst")
    public ModelAndView getMangiResnLIst(XPlatformMapDTO xpDto, Model model) throws Exception {
        ModelAndView modelAndView = new ModelAndView("xplatformMapView");
        DataSetMap listMap = new DataSetMap();
        Map<String, Object> hmParam = new HashMap<String, Object>(); 
        ...
        try  {
            ...
            {
            	List<Map<String, Object>> mList = dlwMangiMemberService.getMangiResnLIst1(hmParam);
                listMap.setRowMaps(mList);
                mapOutDs.put("ds_output", listMap);
            }
            else if(sSvcId.equals("tp_resn2"))
            {
            	List<Map<String, Object>> mList = dlwMangiMemberService.getMangiResnLIst2(hmParam);
                listMap.setRowMaps(mList);
                mapOutDs.put("ds_output2", listMap);
            }
            else if(sSvcId.equals("tp_resn3"))
            {
            	List<Map<String, Object>> mList = dlwMangiMemberService.getMangiResnLIst3(hmParam);
                listMap.setRowMaps(mList);
                mapOutDs.put("ds_output3", listMap);
            }
            else if(sSvcId.equals("tp_resn4"))
            {
            	List<Map<String, Object>> mList = dlwMangiMemberService.getMangiResnLIst4(hmParam);
                listMap.setRowMaps(mList);
