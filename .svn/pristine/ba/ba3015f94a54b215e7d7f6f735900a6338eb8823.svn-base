...
@Service
public class DlwNewTypeConsServiceImpl extends EgovAbstractServiceImpl implements DlwNewTypeConsService {

    @Resource
    public DlwNewTypeConsDAO dlwNewTypeConsDAO;

    private final Logger log = LoggerFactory.getLogger(DlwNewTypeConsServiceImpl.class);
    ...
    public String getDataAthrQury(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDataAthrQury(pmParam);
    }
    ...
    public int getConsCount(Map<String, ?> pmParam) throws Exception {
        return (Integer) dlwNewTypeConsDAO.getConsCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getConsList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getConsList(pmParam);
    }
    ...
    public int getNewTypeConsPopCount(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getNewTypeConsPopCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypeConsPopList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getNewTypeConsPopList(pmParam);
    }
    ...
    public int getIbDpmsReslHstrCount(Map<String, ?> pmParam) throws Exception {
        return (Integer) dlwNewTypeConsDAO.getIbDpmsReslHstrCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getIbDpmsReslHstrList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getIbDpmsReslHstrList(pmParam);
    }
    ...
    public int getVocDtlCount(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getVocDtlCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getVocDtlList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getVocDtlList(pmParam);
    }
    ...
    public int getChatSndgHstrCount(Map<String, ?> pmParam) throws Exception {
        return (Integer) dlwNewTypeConsDAO.getChatSndgHstrCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getChatSndgHstrList(Map<String, ?> param) throws Exception {
        return dlwNewTypeConsDAO.getChatSndgHstrList(param);
    }
    ...
    public int getDlwConsCount(Map<String, ?> pmParam) throws Exception {
        return (Integer) dlwNewTypeConsDAO.getDlwConsCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwConsList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwConsList(pmParam);
    }
    ...
    public int getDlwlifeweyCount(Map<String, ?> pmParam) throws Exception {
        return (Integer) dlwNewTypeConsDAO.getDlwlifeweyCount(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwlifeweyList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwlifeweyList(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypeTrgtCustDtptList(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getNewTypeTrgtCustDtptList(pmParam);
    }
    ...
    public Map<String, Object> getDlwResnAmtList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwResnAmtList(pmParam);
    }
    ...
    public List<Map<String, Object>> getResnAmtDetailList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getResnAmtDetailList(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwPayMngList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwPayMngList(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwPayMngAllList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwPayMngAllList(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwPymnHstrList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwPymnHstrList(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwMemProdAccntList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwMemProdAccntList(pmParam);
    }
    ...
    public List<Map<String, Object>> getDlwAskHstrList(Map<String, ?> pmParam) throws Exception {
        return dlwNewTypeConsDAO.getDlwAskHstrList(pmParam);
    }
    ...
    public List<Map<String, Object>> getMainWdrwLogList(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getMainWdrwLogList(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypeLgUplusPrepayList(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getNewTypeLgUplusPrepayList(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypePayTotInfoList(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getNewTypePayTotInfoList(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypeProductDtl(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getNewTypeProductDtl(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypeProductDtlNxx(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getNewTypeProductDtlNxx(pmParam);
    }
    ...
    public List<Map<String, Object>> getNewTypeProdOptSvcList(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getNewTypeProdOptSvcList(pmParam);
    }
    ...
    public List<Map<String, Object>> getMainWdrwExceList(Map<String, Object> pmParam) {
        return dlwNewTypeConsDAO.getMainWdrwExceList(pmParam);
    }
}