 ...
 */
@Repository
public class AncmTrgtAthrDAO extends EgovAbstractMapper {
    ...
    public List<Map<String, Object>> getAncmTrgtAthrList(String sAncmMtrId) throws Exception {
        return selectList("AncmTrgtAthrMap.getAncmTrgtAthrList", sAncmMtrId);
    }
    ...
    public int insertAncmTrgtAthr(Map<String, ?> pmParam) throws Exception {
        return insert("AncmTrgtAthrMap.insertAncmTrgtAthr", pmParam);
    }
    ...
    public int deleteAncmTrgtAthr(Map<String, ?> pmParam) throws Exception {
        return delete("AncmTrgtAthrMap.deleteAncmTrgtAthr", pmParam);
    }
