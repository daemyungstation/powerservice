...
import powerservice.business.dlw.service.DlwPomDbSearchService;
 ...
 */
@Controller
@RequestMapping(value = "/dlw/pomDbSearch")
public class DlwPomDbSearchController {


    @Resource
    private DlwPomDbSearchService dlwPomDbSearchService;
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/selectPomDbSearchList")
    public ModelAndView selectPomDbSearchList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            List<Map<String, Object>> mList = dlwPomDbSearchService.selectPomDbSearchList(hmParam);
