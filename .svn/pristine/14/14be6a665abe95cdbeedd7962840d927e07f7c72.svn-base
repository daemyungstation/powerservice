 ...
 */
@Repository
public class ConsNewTypeDAO extends EgovAbstractMapper {
	/**
     * 상담 정보의 검색 수를 반환한다.
     *
     * @param pmParam 검색 조건
    ...
    public int getConsCount(Map<String, ?> pmParam) throws Exception {
        return (Integer) selectOne("ConsNewTypeMap.getConsCount", pmParam);
    }
    ...
    public List<Map<String, Object>> getConsList(Map<String, ?> pmParam) throws Exception {
        return selectList("ConsNewTypeMap.getConsList", pmParam);
    }
}
