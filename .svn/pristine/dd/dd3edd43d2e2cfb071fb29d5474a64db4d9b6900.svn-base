...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/theme/css/common-main.css" />
<!-- //CSS -->

<!-- Script -->

<script type="text/javascript" src="${pageContext.request.contextPath}/script/jquery/jquery-1.11.0.min.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/script/kendoui/js/kendo.all.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/script/knockout/knockout-3.1.0.debug.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/script/knockout/knockout.mapping.js"></script>
<!-- script type="text/javascript" src="${pageContext.request.contextPath}/script/knockout/knockout-kendo.min-0.6.9.js"></script -->
<script type="text/javascript" src="${pageContext.request.contextPath}/script/knockout/knockout-kendo-0.8.0.js"></script>
