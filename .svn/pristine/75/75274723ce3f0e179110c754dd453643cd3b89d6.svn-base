...
/**
 * CMS 이력정보를 관리한다. (해약정보/납입이력/결제정보/청구내역)
 *
 ...
 */
@Controller
@RequestMapping(value = "/dlw/cms-hstr")
public class DlwCmsHstrController {

    @Resource
    private DlwCmsHstrService dlwCmsHstrService;
    ...
    public ModelAndView getDlwPayMngList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            if ("1".equals(sPyinTyp)) {			// 상조부금
                mList = dlwCmsHstrService.getDlwPayMngList(hmParam);
            } else if ("2".equals(sPyinTyp)) {	// 결합상품할부원금
                mList = dlwCmsHstrService.getDlwPayMngDtlList(hmParam);
            } else {							// 결합상품추가부담금
                mList = dlwCmsHstrService.getDlwPayMngDtl1List(hmParam);
            }
    ...
    public ModelAndView getDlwPayMngAllList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            hmParam.put("accnt_no", sAccntNo);
            mList = dlwCmsHstrService.getDlwPayMngAllList(hmParam);
    ...
    public ModelAndView getDlwCnctList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            if (srchInDs != null && srchInDs.size() > 0) {
                ...
                Map<String, Object> mDtpt = dlwCmsHstrService.getDlwResnAmtList(hmParam); // 적용일자 및 SEQ 조회
                ...
                if (mDtpt != null) {
                    ...
                    List<Map<String, Object>> mRntmList = dlwCmsHstrService.getDlwPayMngList(hmParam);
                    if (mRntmList.size() > 0) {
    ...
    public ModelAndView getDlwPymnHstrList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            hmParam.put("accnt_no", sAccntNo);
            mList = dlwCmsHstrService.getDlwPymnHstrList(hmParam);
            listMap.setRowMaps(mList);
            mapOutDs.put("ds_output", listMap);
    ...
    public ModelAndView getDlwAskHstrList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            hmParam.put("accnt_no", sAccntNo);
            mList = dlwCmsHstrService.getDlwAskHstrList(hmParam);
            listMap.setRowMaps(mList);
            mapOutDs.put("ds_output", listMap);
