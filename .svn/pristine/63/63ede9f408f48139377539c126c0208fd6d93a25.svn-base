...
<head>
    ...
    <link href="/powerservice/script/util/prettify/prettify.css" rel="stylesheet">
</head>
<body>
<div class="navbar">
...
<script src="/powerservice/script/jquery/jquery-1.11.0.min.js"></script>
<!-- script src="/resources/js/bootstrap.min.js"></script -->
<script src="/powerservice/script/util/socket.io/socket.io.min-0.9.16.js"></script>
<script src="/powerservice/script/util/prettify/prettify.js"></script>
