...
import powerservice.business.dlw.service.DlwHsResultService;
 ...
 */
@Controller
@RequestMapping(value = "/dlw/hsResult")
public class DlwHsResultController {


    @Resource
    private DlwHsResultService dlwHsResultService;
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/selectHsResultList")
    public ModelAndView selectHsResultList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ...
        try {
            ...
            List<Map<String, Object>> mList = dlwHsResultService.selectHsResultList(hmParam);
...
//System.out.println("selectProdOptSvcMstList total_cnt===>"+pMap2.get("total_cnt"));
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/selectHsProdList")
    public ModelAndView selectHsProdList(XPlatformMapDTO xpDto, Model model) throws Exception {
        ModelAndView modelAndView = new ModelAndView("xplatformMapView");
        DataSetMap listMap = new DataSetMap();
        Map<String, Object> hmParam = new HashMap<String, Object>();
        ...
        try {
            ...
            List<Map<String, Object>> mList = dlwHsResultService.selectHsProdList(hmParam);
            if (mList != null && mList.size() > 0) {
                Map pMap2 = mList.get(0);
